...
// WiFi credentials
const char* ssid = process.env.WIFI_SSID;
const char* password = process.env.WIFI_PASSWORD;

// Server configuration
const char* serverURL = process.env.SERVER_URL; // Update with your server IP
